...
# Introduction
<p align="justify">
This material is supplementary to our manuscript <i>"Molecular docking coupled with machine learning to screen inhibitors of SARS-CoV-2: A comprehensive analysis of the structure of the potential ligands (to pe published)"</i>. The codes, here available, were used to the SARS-CoV-2 spike protein, but are suitable for any molecules and can be used for: </p><br>
